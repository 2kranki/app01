...
//============================================================================
//                        Handlers for App01ms.Vendor
//============================================================================

type HandlersApp01msVendor struct {
    mu          sync.Mutex
...
func (h *HandlersApp01msVendor) DB() *ioApp01msVendor.IO_App01msVendor {
    return h.db
}

func (h *HandlersApp01msVendor) SetDB(db *ioApp01msVendor.IO_App01msVendor) {
    h.db = db
}

func (h *HandlersApp01msVendor) RowsPerPage() int {
    return h.rowsPerPage
}

func (h *HandlersApp01msVendor) SetRowsPerPage(r int) {
    h.rowsPerPage = r
}
...
// with it given a mux.
func (h *HandlersApp01msVendor) SetupHandlers(mux *http.ServeMux) {
...
func NewHandlersApp01msVendor(db *ioApp01msVendor.IO_App01msVendor, rowsPerPage int, mux *http.ServeMux) *HandlersApp01msVendor {
    var h       *HandlersApp01msVendor

 	h = &HandlersApp01msVendor{db:db, rowsPerPage:rowsPerPage}
    if h == nil {
        log.Fatalf("Error: Unable to allocate Handlers for hndlrApp01msVendor!\n")
    }
    h.SetupHandlers(mux)
...
func (h *HandlersApp01msVendor) ListFirst(w http.ResponseWriter, r *http.Request) {
...
func (h *HandlersApp01msVendor) ListLast(w http.ResponseWriter, r *http.Request) {
    var err     error
    var offset  int
...
func (h *HandlersApp01msVendor) ListNext(w http.ResponseWriter, r *http.Request) {
    var err     error
    var offset  int
    var cTable  int
...
func (h *HandlersApp01msVendor) ListPrev(w http.ResponseWriter, r *http.Request) {
    var err     error
    var offset  int
    var begin   int
    var cTable  int
...
func (h *HandlersApp01msVendor) ListShow(w http.ResponseWriter, offset int, msg string) {
    var err     error
    var rcds    []App01msVendor.App01msVendor
    var name    = "App01ms.Vendor.list.gohtml"
    ...
    data := struct {
                Rcds        []App01msVendor.App01msVendor
                Offset      int
                Msg         string
            }{rcds, offset, msg}
...
func (h *HandlersApp01msVendor) RowDelete(w http.ResponseWriter, r *http.Request) {
    var err     error
...
func (h *HandlersApp01msVendor) RowDisplay(w http.ResponseWriter, rcd  *App01msVendor.App01msVendor, msg string) {
    var err     error
    var str     strings.Builder
    ...
    if h.Tmpls != nil {
        data := struct {
                    Rcd         *App01msVendor.App01msVendor
                    Msg         string
                }{rcd, msg}
        name := "App01ms.Vendor.form.gohtml"
        log.Printf("\tRcd: %+v\n", data.Rcd)
            log.Printf("\tMsg: %s\n", data.Msg)
            log.Printf("\tname: %s\n", name)
        log.Printf("\tExecuting template: %s\n", name)
...
func (h *HandlersApp01msVendor) RowEmpty(w http.ResponseWriter, r *http.Request) {
    var rcd     App01msVendor.App01msVendor
...
func (h *HandlersApp01msVendor) RowFind(w http.ResponseWriter, r *http.Request) {
    var err     error
    var rcd     App01msVendor.App01msVendor
    var msg     string
    var i       int
...
func (h *HandlersApp01msVendor) RowFirst(w http.ResponseWriter, r *http.Request) {
    var rcd     App01msVendor.App01msVendor
    var err     error
...
func (h *HandlersApp01msVendor) RowForm(w http.ResponseWriter, r *http.Request) {
    ...
    // Display the row in the form.
    http.ServeFile(w, r, "./tmpl/App01ms.Vendor.form.gohtml")
...
func (h *HandlersApp01msVendor) RowInsert(w http.ResponseWriter, r *http.Request) {
    var rcd         App01msVendor.App01msVendor
    var err         error
...
func (h *HandlersApp01msVendor) RowLast(w http.ResponseWriter, r *http.Request) {
    var rcd         App01msVendor.App01msVendor
    var err         error
...
func (h *HandlersApp01msVendor) RowNext(w http.ResponseWriter, r *http.Request) {
    var rcd         App01msVendor.App01msVendor
    var err         error
    var i           int
    var key         string
...
func (h *HandlersApp01msVendor) RowPrev(w http.ResponseWriter, r *http.Request) {
    var rcd         App01msVendor.App01msVendor
    var err         error
    var i           int
    var key         string
...
func (h *HandlersApp01msVendor) RowShow(w http.ResponseWriter, r *http.Request) {
    var err         error
    var key         string
    var rcd         App01msVendor.App01msVendor
...
func (h *HandlersApp01msVendor) RowUpdate(w http.ResponseWriter, r *http.Request) {
    var err         error
    var key         string
    var rcd         App01msVendor.App01msVendor
    var i           int
...
func (h *HandlersApp01msVendor) TableCreate(w http.ResponseWriter, r *http.Request) {
    var err         error
...
func (h *HandlersApp01msVendor) TableLoadCSV(w http.ResponseWriter, r *http.Request) {
    var err         error
    var rcd         App01msVendor.App01msVendor
...
// in some test rows.
func (h *HandlersApp01msVendor) TableLoadTestData(w http.ResponseWriter, r *http.Request) {
    var err         error
    var rcd         App01msVendor.App01msVendor
...
// data from a CSV file.
func (h *HandlersApp01msVendor) TableSaveCSV(w http.ResponseWriter, r *http.Request) {
    var err         error
    var cntGood     int
    var cntTotal    int
    ...
    // Write the CSV file.
    if wtr != nil {
        apply := func (rcd App01msVendor.App01msVendor) error {
                    log.Printf("\tRow: %v\n", rcd.ToStrings())
        ...
        log.Printf("\t%s - for App01msVendor table!\n", util.ErrorString(err))
    }
