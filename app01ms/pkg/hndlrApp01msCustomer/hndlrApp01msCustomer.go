...
//============================================================================
//                        Handlers for App01ms.Customer
//============================================================================

type HandlersApp01msCustomer struct {
    mu          sync.Mutex
...
func (h *HandlersApp01msCustomer) DB() *ioApp01msCustomer.IO_App01msCustomer {
    return h.db
}

func (h *HandlersApp01msCustomer) SetDB(db *ioApp01msCustomer.IO_App01msCustomer) {
    h.db = db
}

func (h *HandlersApp01msCustomer) RowsPerPage() int {
    return h.rowsPerPage
}

func (h *HandlersApp01msCustomer) SetRowsPerPage(r int) {
    h.rowsPerPage = r
}
...
// with it given a mux.
func (h *HandlersApp01msCustomer) SetupHandlers(mux *http.ServeMux) {
...
func NewHandlersApp01msCustomer(db *ioApp01msCustomer.IO_App01msCustomer, rowsPerPage int, mux *http.ServeMux) *HandlersApp01msCustomer {
    var h       *HandlersApp01msCustomer

 	h = &HandlersApp01msCustomer{db:db, rowsPerPage:rowsPerPage}
    if h == nil {
        log.Fatalf("Error: Unable to allocate Handlers for hndlrApp01msCustomer!\n")
    }
    h.SetupHandlers(mux)
...
func (h *HandlersApp01msCustomer) ListFirst(w http.ResponseWriter, r *http.Request) {
...
func (h *HandlersApp01msCustomer) ListLast(w http.ResponseWriter, r *http.Request) {
    var err     error
    var offset  int
...
func (h *HandlersApp01msCustomer) ListNext(w http.ResponseWriter, r *http.Request) {
    var err     error
    var offset  int
    var cTable  int
...
func (h *HandlersApp01msCustomer) ListPrev(w http.ResponseWriter, r *http.Request) {
    var err     error
    var offset  int
    var begin   int
    var cTable  int
...
func (h *HandlersApp01msCustomer) ListShow(w http.ResponseWriter, offset int, msg string) {
    var err     error
    var rcds    []App01msCustomer.App01msCustomer
    var name    = "App01ms.Customer.list.gohtml"
    ...
    data := struct {
                Rcds        []App01msCustomer.App01msCustomer
                Offset      int
                Msg         string
            }{rcds, offset, msg}
...
func (h *HandlersApp01msCustomer) RowDelete(w http.ResponseWriter, r *http.Request) {
    var err     error
...
func (h *HandlersApp01msCustomer) RowDisplay(w http.ResponseWriter, rcd  *App01msCustomer.App01msCustomer, msg string) {
    var err     error
    ...
    if h.Tmpls != nil {
        data := struct {
                    Rcd         *App01msCustomer.App01msCustomer
                    Msg         string
                }{rcd, msg}
        name := "App01ms.Customer.form.gohtml"
...
func (h *HandlersApp01msCustomer) RowEmpty(w http.ResponseWriter, r *http.Request) {
    var rcd     App01msCustomer.App01msCustomer
...
func (h *HandlersApp01msCustomer) RowFind(w http.ResponseWriter, r *http.Request) {
    var err     error
    var rcd     App01msCustomer.App01msCustomer
    var msg     string
    var i       int
...
func (h *HandlersApp01msCustomer) RowFirst(w http.ResponseWriter, r *http.Request) {
    var rcd     App01msCustomer.App01msCustomer
    var err     error
...
func (h *HandlersApp01msCustomer) RowForm(w http.ResponseWriter, r *http.Request) {
    ...
    // Display the row in the form.
    http.ServeFile(w, r, "./tmpl/App01ms.Customer.form.gohtml")
...
func (h *HandlersApp01msCustomer) RowInsert(w http.ResponseWriter, r *http.Request) {
    var rcd         App01msCustomer.App01msCustomer
    var err         error
...
func (h *HandlersApp01msCustomer) RowLast(w http.ResponseWriter, r *http.Request) {
    var rcd         App01msCustomer.App01msCustomer
    var err         error
...
func (h *HandlersApp01msCustomer) RowNext(w http.ResponseWriter, r *http.Request) {
    var rcd         App01msCustomer.App01msCustomer
    var err         error
    var i           int
    var key         string
...
func (h *HandlersApp01msCustomer) RowPrev(w http.ResponseWriter, r *http.Request) {
    var rcd         App01msCustomer.App01msCustomer
    var err         error
    var i           int
    var key         string
...
func (h *HandlersApp01msCustomer) RowShow(w http.ResponseWriter, r *http.Request) {
    var err         error
    var key         string
    var rcd         App01msCustomer.App01msCustomer
...
func (h *HandlersApp01msCustomer) RowUpdate(w http.ResponseWriter, r *http.Request) {
    var err         error
    var key         string
    var rcd         App01msCustomer.App01msCustomer
    var i           int
...
func (h *HandlersApp01msCustomer) TableCreate(w http.ResponseWriter, r *http.Request) {
    var err         error
...
func (h *HandlersApp01msCustomer) TableLoadCSV(w http.ResponseWriter, r *http.Request) {
    var err         error
    var rcd         App01msCustomer.App01msCustomer
...
// in some test rows.
func (h *HandlersApp01msCustomer) TableLoadTestData(w http.ResponseWriter, r *http.Request) {
    var err         error
    var rcd         App01msCustomer.App01msCustomer
...
// data from a CSV file.
func (h *HandlersApp01msCustomer) TableSaveCSV(w http.ResponseWriter, r *http.Request) {
    var err         error
    var cntGood     int
    var cntTotal    int
    ...
    if wtr != nil {
        ...
        log.Printf("\t%s - for App01msCustomer table!\n", util.ErrorString(err))
    }
