...
func (h *HandlersApp01msVendor) DB() *IO_App01msVendor {
    return h.db
}

func (h *HandlersApp01msVendor) SetDB(db *IO_App01msVendor) {
    h.db = db
}
...
func NewHandlersApp01msVendor(db *IO_App01msVendor, rowsPerPage int, mux *http.ServeMux) *HandlersApp01msVendor {
...
func (h *HandlersApp01msVendor) RowDisplay(w http.ResponseWriter, rcd  *App01msVendor, msg string) {
    var err     error
