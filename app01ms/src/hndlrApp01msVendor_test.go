...
// If it fails at something, it must issue a t.Fatalf().
func (td *TestData_App01msVendor) ResponseBody() string {
	var str string
...
// If it fails at something, it must issue a t.Fatalf().
func (td *TestData_App01msVendor) Setup(t *testing.T) {
...
func TestApp01msVendorHndlrListShow(t *testing.T) {
	var td *TestData_App01msVendor
...
func TestApp01msVendorHndlrRowEmpty(t *testing.T) {
	var td *TestData_App01msVendor
	/*****
	   expectedBody    := ""
	*****/
...
func TestApp01msVendorHndlrRowLastPrev(t *testing.T) {
	var td *TestData_App01msVendor
...
func TestApp01msVendorHndlrRowDisplay(t *testing.T) {
	var td *TestData_App01msVendor
...
func TestApp01msVendorHndlrRowUpdate(t *testing.T) {
	var td *TestData_App01msVendor
