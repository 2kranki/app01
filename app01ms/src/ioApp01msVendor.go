...
func (io *IO_App01msVendor) RowDelete(rcd *App01msVendor) error {
	var err error
...
func (io *IO_App01msVendor) RowFind(rcd *App01msVendor) error {
	var err error
...
// without error.
func (io *IO_App01msVendor) RowFirst(rcd *App01msVendor) error {
	var err error
...
func (io *IO_App01msVendor) RowInsert(d *App01msVendor) error {
	var err error
...
func (io *IO_App01msVendor) RowLast(rcd *App01msVendor) error {
	var err error
...
func (io *IO_App01msVendor) RowNext(rcd *App01msVendor) error {
	var err error
...
func (io *IO_App01msVendor) RowPage(offset int, limit int) ([]App01msVendor, error) {
	var err error
...
func (io *IO_App01msVendor) RowPrev(rcd *App01msVendor) error {
	var err error
...
func (io *IO_App01msVendor) RowUpdate(d *App01msVendor) error {
	var err error
	var sqlStmt = "INSERT INTO dbo.vendor (name, addr1, addr2, city, state, zip, curbal) VALUES (?, ?, ?, ?, ?, ?, ?);\n"
...
// them.
func (io *IO_App01msVendor) TableScan(apply func(rcd App01msVendor) error) error {
	var sqlStmt = "DROP TABLE IF EXISTS dbo.vendor;\n"
	var err error
	var rcd App01msVendor
...
func NewIoApp01msVendor(io *IO_App01ms) *IO_App01msVendor {
	db := &IO_App01msVendor{}
	if io == nil {
		db.io = NewIoApp01ms()
	} else {
