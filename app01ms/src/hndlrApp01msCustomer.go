...
func (h *HandlersApp01msCustomer) DB() *IO_App01msCustomer {
	return h.db
}

func (h *HandlersApp01msCustomer) SetDB(db *IO_App01msCustomer) {
	h.db = db
}
...
func NewHandlersApp01msCustomer(db *IO_App01msCustomer, rowsPerPage int, mux *http.ServeMux) *HandlersApp01msCustomer {
...
func (h *HandlersApp01msCustomer) RowDisplay(w http.ResponseWriter, rcd *App01msCustomer, msg string) {
	var err error
