...
// Generated: Wed Sep 25, 2019 15:48 for mssql Database
...
func (io *IO_App01msCustomer) RowDelete(rcd *App01msCustomer) error {
	var err error
...
func (io *IO_App01msCustomer) RowFind(rcd *App01msCustomer) error {
	var err error
...
// without error.
func (io *IO_App01msCustomer) RowFirst(rcd *App01msCustomer) error {
	var err error
...
func (io *IO_App01msCustomer) RowInsert(d *App01msCustomer) error {
	var err error
...
func (io *IO_App01msCustomer) RowLast(rcd *App01msCustomer) error {
	var err error
...
func (io *IO_App01msCustomer) RowNext(rcd *App01msCustomer) error {
	var err error
...
func (io *IO_App01msCustomer) RowPage(offset int, limit int) ([]App01msCustomer, error) {
	var err error
	var sqlStmt = "SELECT * FROM dbo.Customer ORDER BY num ASC OFFSET ? ROWS FETCH NEXT ? ROWS ONLY;\n"
	data := []App01msCustomer{}
...
func (io *IO_App01msCustomer) RowPrev(rcd *App01msCustomer) error {
	var err error
	var sqlStmt = "SELECT * FROM dbo.Customer WHERE num < ? ORDER BY num DESC OFFSET 0 ROWS;\n%!(EXTRA string=FETCH NEXT 1 ROW ONLY)"
...
func (io *IO_App01msCustomer) RowUpdate(d *App01msCustomer) error {
	var err error
	var sqlStmt = "INSERT INTO dbo.customer (num, name, addr1, addr2, city, state, zip, curbal) VALUES (?, ?, ?, ?, ?, ?, ?, ?);\n"
...
// them.
func (io *IO_App01msCustomer) TableScan(apply func(rcd App01msCustomer) error) error {
	var sqlStmt = "DROP TABLE IF EXISTS dbo.customer;\n"
	var err error
	var rcd App01msCustomer
...
func NewIoApp01msCustomer(io *IO_App01ms) *IO_App01msCustomer {
