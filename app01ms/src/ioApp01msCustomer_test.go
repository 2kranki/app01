...
func TestApp01msCustomerCreateDeleteTable(t *testing.T) {
	var err error
...
func TestApp01msCustomerRowInsert(t *testing.T) {
	var err error
	var td *App01msCustomerTestData
	var io *IO_App01msCustomer
...
func TestApp01msCustomerRowPage(t *testing.T) {
	var err error
	var td *App01msCustomerTestData
	var io *IO_App01msCustomer
	var rcd App01msCustomer
...
func TestApp01msCustomerTableScan(t *testing.T) {
	var err error
	var td *App01msCustomerTestData
	var io *IO_App01msCustomer
	var rcd App01msCustomer
