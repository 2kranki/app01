...
oArgs       = None
szAppName   = 'App01ms'
szDbName    = 'mcr.microsoft.com/mssql/server' # docker name used to pull the image
szDbTag     = '2017-latest' # docker tag used to pull the image
szGoDir     = '${HOME}/go'
...
def         parseArgs(listArgV=None):
    ...
    oCmdPrs.add_argument('--appname', action='store', dest='szAppName',
                         default='app01ms', help='Set Application Base Name'
                         )
