...
func (h *HandlersApp01myCustomer) DB() *IO_App01myCustomer {
	return h.db
}

func (h *HandlersApp01myCustomer) SetDB(db *IO_App01myCustomer) {
	h.db = db
}
...
func NewHandlersApp01myCustomer(db *IO_App01myCustomer, rowsPerPage int, mux *http.ServeMux) *HandlersApp01myCustomer {
...
func (h *HandlersApp01myCustomer) ListShow(w http.ResponseWriter, offset int) {
	var err error
	var rcds []App01myCustomer
...
func (h *HandlersApp01myCustomer) RowDisplay(w http.ResponseWriter, rcd *App01myCustomer, msg string) {
	var err error
...
func (h *HandlersApp01myCustomer) TableSaveCSV(w http.ResponseWriter, r *http.Request) {
	...
	// Write the CSV file.
	if wtr != nil {
		apply := func(rcd App01myCustomer) error {
			log.Printf("\tRow: %v\n", rcd.ToStrings())
