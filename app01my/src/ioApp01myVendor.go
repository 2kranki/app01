...
func (io *IO_App01myVendor) RowDelete(rcd *App01myVendor) error {
	var err error
...
func (io *IO_App01myVendor) RowFind(rcd *App01myVendor) error {
	var err error
...
// without error.
func (io *IO_App01myVendor) RowFirst(rcd *App01myVendor) error {
	var err error
...
func (io *IO_App01myVendor) RowInsert(d *App01myVendor) error {
	var err error
...
func (io *IO_App01myVendor) RowLast(rcd *App01myVendor) error {
	var err error
...
func (io *IO_App01myVendor) RowNext(rcd *App01myVendor) error {
	var err error
...
func (io *IO_App01myVendor) RowPage(offset int, limit int) ([]App01myVendor, error) {
	var err error
...
func (io *IO_App01myVendor) RowPrev(rcd *App01myVendor) error {
	var err error
...
func (io *IO_App01myVendor) RowUpdate(d *App01myVendor) error {
	var err error
	var sqlStmt = "INSERT INTO vendor (name, addr1, addr2, city, state, zip, curbal) VALUES (?, ?, ?, ?, ?, ?, ?);\n"
...
// them.
func (io *IO_App01myVendor) TableScan(apply func(rcd App01myVendor) error) error {
	var sqlStmt = "DROP TABLE IF EXISTS vendor;\n"
	var err error
	var rcd App01myVendor
...
func NewIoApp01myVendor(io *IO_App01my) *IO_App01myVendor {
	db := &IO_App01myVendor{}
	if io == nil {
		db.io = NewIoApp01my()
	} else {
