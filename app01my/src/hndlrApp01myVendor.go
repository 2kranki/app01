...
func (h *HandlersApp01myVendor) DB() *IO_App01myVendor {
	return h.db
}

func (h *HandlersApp01myVendor) SetDB(db *IO_App01myVendor) {
	h.db = db
}
...
func NewHandlersApp01myVendor(db *IO_App01myVendor, rowsPerPage int, mux *http.ServeMux) *HandlersApp01myVendor {
...
func (h *HandlersApp01myVendor) ListShow(w http.ResponseWriter, offset int) {
	var err error
...
func (h *HandlersApp01myVendor) RowDisplay(w http.ResponseWriter, rcd *App01myVendor, msg string) {
	var err error
