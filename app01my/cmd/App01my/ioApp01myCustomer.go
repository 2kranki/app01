...
// Generated: Thu Sep 26, 2019 13:51 for mysql Database
...
func (io *IO_App01myCustomer) RowDelete(rcd *App01myCustomer) error {
	var err error
...
func (io *IO_App01myCustomer) RowFind(rcd *App01myCustomer) error {
	var err error
...
// without error.
func (io *IO_App01myCustomer) RowFirst(rcd *App01myCustomer) error {
	var err error
...
func (io *IO_App01myCustomer) RowInsert(d *App01myCustomer) error {
	var err error
...
func (io *IO_App01myCustomer) RowLast(rcd *App01myCustomer) error {
	var err error
...
func (io *IO_App01myCustomer) RowNext(rcd *App01myCustomer) error {
	var err error
...
func (io *IO_App01myCustomer) RowPage(offset int, limit int) ([]App01myCustomer, error) {
	var err error
	var sqlStmt = "SELECT * FROM customer ORDER BY num ASC LIMIT ? OFFSET ?;\n"
	data := []App01myCustomer{}
...
func (io *IO_App01myCustomer) RowPrev(rcd *App01myCustomer) error {
	var err error
...
func (io *IO_App01myCustomer) RowUpdate(d *App01myCustomer) error {
	var err error
	var sqlStmt = "INSERT INTO customer (num, name, addr1, addr2, city, state, zip, curbal) VALUES (?, ?, ?, ?, ?, ?, ?, ?);\n"
...
// them.
func (io *IO_App01myCustomer) TableScan(apply func(rcd App01myCustomer) error) error {
	var sqlStmt = "DROP TABLE IF EXISTS customer;\n"
	var err error
	var rcd App01myCustomer
...
func NewIoApp01myCustomer(io *IO_App01my) *IO_App01myCustomer {
