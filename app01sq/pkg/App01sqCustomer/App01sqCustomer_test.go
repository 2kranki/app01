...
func TestTestDataApp01sqCustomer(t *testing.T) {
    var chr         rune
    var str         string
    var i64         int64
...
func TestToStringApp01sqCustomer(t *testing.T) {
    var str         string
    var strRcd      string
...
func TestToStringsApp01sqCustomer(t *testing.T) {
    var strs        []string
    var str         string
    var offset      int
