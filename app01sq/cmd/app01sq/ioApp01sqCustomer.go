...
// Generated: Thu Oct 17, 2019 11:49 for sqlite Database
...
func (io *IO_App01sqCustomer) RowDelete(rcd *App01sqCustomer) error {
    var err         error
...
func (io *IO_App01sqCustomer) RowFind(rcd *App01sqCustomer) error {
    var err         error
...
// without error.
func (io *IO_App01sqCustomer) RowFirst(rcd *App01sqCustomer) error {
    var err         error
...
func (io *IO_App01sqCustomer) RowInsert(d *App01sqCustomer) error {
    var err     error
...
func (io *IO_App01sqCustomer) RowLast(rcd *App01sqCustomer) error {
    var err         error
...
func (io *IO_App01sqCustomer) RowNext(rcd *App01sqCustomer) error {
    var err         error
...
func (io *IO_App01sqCustomer) RowPage(offset int, limit int) ([]App01sqCustomer, error) {
    var err         error
    var sqlStmt = "SELECT * FROM customer ORDER BY num ASC LIMIT ? OFFSET ?;\n"
    data := []App01sqCustomer{}
...
func (io *IO_App01sqCustomer) RowPrev(rcd *App01sqCustomer) error {
    var err         error
...
func (io *IO_App01sqCustomer) RowUpdate(d *App01sqCustomer) error {
    var err     error
    var sqlStmt = "INSERT INTO customer (num, name, addr1, addr2, city, state, zip, curbal) VALUES (?, ?, ?, ?, ?, ?, ?, ?);\n"
...
// them.
func (io *IO_App01sqCustomer) TableScan(apply func (rcd App01sqCustomer) error) error {
    var sqlStmt = "DROP TABLE IF EXISTS customer;\n"
    var err     error
    var rcd     App01sqCustomer
...
func NewIoApp01sqCustomer(io *IO_App01sq) *IO_App01sqCustomer {
