...
func (h *HandlersApp01sqCustomer) DB() *IO_App01sqCustomer {
    return h.db
}

func (h *HandlersApp01sqCustomer) SetDB(db *IO_App01sqCustomer) {
    h.db = db
}
...
func NewHandlersApp01sqCustomer(db *IO_App01sqCustomer, rowsPerPage int, mux *http.ServeMux) *HandlersApp01sqCustomer {
...
func (h *HandlersApp01sqCustomer) RowDisplay(w http.ResponseWriter, rcd  *App01sqCustomer, msg string) {
    var err     error
