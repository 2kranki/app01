...
func (h *HandlersApp01maCustomer) DB() *IO_App01maCustomer {
	return h.db
}

func (h *HandlersApp01maCustomer) SetDB(db *IO_App01maCustomer) {
	h.db = db
}
...
func NewHandlersApp01maCustomer(db *IO_App01maCustomer, rowsPerPage int, mux *http.ServeMux) *HandlersApp01maCustomer {
...
func (h *HandlersApp01maCustomer) ListShow(w http.ResponseWriter, offset int) {
	var err error
	var rcds []App01maCustomer
...
func (h *HandlersApp01maCustomer) RowDisplay(w http.ResponseWriter, rcd *App01maCustomer, msg string) {
	var err error
...
func (h *HandlersApp01maCustomer) TableSaveCSV(w http.ResponseWriter, r *http.Request) {
	...
	// Write the CSV file.
	if wtr != nil {
		apply := func(rcd App01maCustomer) error {
			log.Printf("\tRow: %v\n", rcd.ToStrings())
