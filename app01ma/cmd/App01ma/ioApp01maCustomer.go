...
// Generated: Wed Oct 16, 2019 20:04 for mariadb Database
...
func (io *IO_App01maCustomer) RowDelete(rcd *App01maCustomer) error {
    var err         error
...
func (io *IO_App01maCustomer) RowFind(rcd *App01maCustomer) error {
    var err         error
...
// without error.
func (io *IO_App01maCustomer) RowFirst(rcd *App01maCustomer) error {
    var err         error
...
func (io *IO_App01maCustomer) RowInsert(d *App01maCustomer) error {
    var err     error
...
func (io *IO_App01maCustomer) RowLast(rcd *App01maCustomer) error {
    var err         error
...
func (io *IO_App01maCustomer) RowNext(rcd *App01maCustomer) error {
    var err         error
...
func (io *IO_App01maCustomer) RowPage(offset int, limit int) ([]App01maCustomer, error) {
    var err         error
    var sqlStmt = "SELECT * FROM customer ORDER BY num ASC LIMIT ? OFFSET ?;\n"
    data := []App01maCustomer{}
...
func (io *IO_App01maCustomer) RowPrev(rcd *App01maCustomer) error {
    var err         error
...
func (io *IO_App01maCustomer) RowUpdate(d *App01maCustomer) error {
    var err     error
    var sqlStmt = "INSERT INTO customer (num, name, addr1, addr2, city, state, zip, curbal) VALUES (?, ?, ?, ?, ?, ?, ?, ?);\n"
...
// them.
func (io *IO_App01maCustomer) TableScan(apply func (rcd App01maCustomer) error) error {
    var sqlStmt = "DROP TABLE IF EXISTS customer;\n"
    var err     error
    var rcd     App01maCustomer
...
func NewIoApp01maCustomer(io *IO_App01ma) *IO_App01maCustomer {
