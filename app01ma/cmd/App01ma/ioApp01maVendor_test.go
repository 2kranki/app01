...
// they do not match.
func (td *App01maVendorTestData) CheckRcd(need int, rcd *App01maVendor) {
...
func TestApp01maVendorCreateDeleteTable(t *testing.T) {
    var err         error
    var td          *App01maVendorTestData
    var io          *IO_App01maVendor

	t.Logf("TestCreateTable()...\n")
	DockerRun(t)
	td = NewTestApp01maVendor()
	td.Setup(t)
	io = NewIoApp01maVendor(td.io)
...
func TestApp01maVendorRowInsert(t *testing.T) {
    var err         error
    var td          *App01maVendorTestData
    var io          *IO_App01maVendor
...
func TestApp01maVendorRowPage(t *testing.T) {
    var err         error
    var td          *App01maVendorTestData
    var io          *IO_App01maVendor
    var rcd         App01maVendor
...
func TestApp01maVendorTableScan(t *testing.T) {
    var err         error
    var td          *App01maVendorTestData
    var io          *IO_App01maVendor
    var rcd         App01maVendor
    ...
    apply := func (rcd App01maVendor) error {
                t.Logf("\tScan Row %d\n", cnt)
                cnt++
                return nil
             }
