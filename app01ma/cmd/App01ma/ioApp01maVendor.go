...
func (io *IO_App01maVendor) RowDelete(rcd *App01maVendor) error {
	var err error
...
func (io *IO_App01maVendor) RowFind(rcd *App01maVendor) error {
	var err error
...
// without error.
func (io *IO_App01maVendor) RowFirst(rcd *App01maVendor) error {
	var err error
...
func (io *IO_App01maVendor) RowInsert(d *App01maVendor) error {
	var err error
...
func (io *IO_App01maVendor) RowLast(rcd *App01maVendor) error {
	var err error
...
func (io *IO_App01maVendor) RowNext(rcd *App01maVendor) error {
	var err error
...
func (io *IO_App01maVendor) RowPage(offset int, limit int) ([]App01maVendor, error) {
	var err error
...
func (io *IO_App01maVendor) RowPrev(rcd *App01maVendor) error {
	var err error
...
func (io *IO_App01maVendor) RowUpdate(d *App01maVendor) error {
	var err error
	var sqlStmt = "INSERT INTO vendor (name, addr1, addr2, city, state, zip, curbal) VALUES (?, ?, ?, ?, ?, ?, ?);\n"
...
// them.
func (io *IO_App01maVendor) TableScan(apply func(rcd App01maVendor) error) error {
	var sqlStmt = "DROP TABLE IF EXISTS vendor;\n"
	var err error
	var rcd App01maVendor
...
func NewIoApp01maVendor(io *IO_App01ma) *IO_App01maVendor {
	db := &IO_App01maVendor{}
	if io == nil {
		db.io = NewIoApp01ma()
	} else {
