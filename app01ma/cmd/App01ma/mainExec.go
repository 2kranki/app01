...
func exec() {
	...
	ioApp01ma := ioApp01ma.NewIoApp01ma()
	...
	ioApp01maCustomer := ioApp01maCustomer.NewIoApp01maCustomer(ioApp01ma)
	if ioApp01maCustomer == nil {
		log.Fatalf("ERROR - Failed to Connect to Table, App01maCustomer\n\n\n")
	}
	ioApp01maVendor := ioApp01maVendor.NewIoApp01maVendor(ioApp01ma)
	...
	hndlrsApp01ma = hndlrApp01ma.NewTmplsApp01ma("")
	...
	hndlrsApp01maCustomer = hndlrApp01maCustomer.NewHandlersApp01maCustomer(ioApp01maCustomer, RowsPerPage, mux)
	...
	hndlrsApp01maVendor = hndlrApp01maVendor.NewHandlersApp01maVendor(ioApp01maVendor, RowsPerPage, mux)
