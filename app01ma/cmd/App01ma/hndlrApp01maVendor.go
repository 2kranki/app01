...
func (h *HandlersApp01maVendor) DB() *IO_App01maVendor {
	return h.db
}

func (h *HandlersApp01maVendor) SetDB(db *IO_App01maVendor) {
	h.db = db
}
...
func NewHandlersApp01maVendor(db *IO_App01maVendor, rowsPerPage int, mux *http.ServeMux) *HandlersApp01maVendor {
...
func (h *HandlersApp01maVendor) RowDisplay(w http.ResponseWriter, rcd *App01maVendor, msg string) {
	var err error
