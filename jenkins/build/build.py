...
def         perform_actions():
    ...
    if args.verbose > 0:
        ...
        print('*****************************************')
        print()
    rc = util.do_cmd("./jenkins/build/build.py", 'app01ma')
    if not rc == 0:
        print("Error: Failed to build 'app01ma'!\n")
        return 4
    rc = util.do_cmd("./jenkins/build/build.py", 'app01ms')
    if not rc == 0:
        print("Error: Failed to build 'app01ms'!\n")
        return 4
    rc = util.do_cmd("./jenkins/build/build.py", 'app01my')
    if not rc == 0:
        print("Error: Failed to build 'app01my'!\n")
        return 4
    rc = util.do_cmd("./jenkins/build/build.py", 'app01pg')
    if not rc == 0:
        print("Error: Failed to build 'app01pg'!\n")
        return 4
    rc = util.do_cmd("./jenkins/build/build.py", 'app01sq')
    if not rc == 0:
