...
def         perform_actions():
    ...
    if not rc == 0:
        ...
        return 4
    rc = util.do_cmd("./jenkins/review/review.py", 'app01ms')
    if not rc == 0:
        print("Error: Reviewing failed for: 'app01ms'!\n")
        return 4
    rc = util.do_cmd("./jenkins/review/review.py", 'app01my')
    if not rc == 0:
        print("Error: Reviewing failed for: 'app01my'!\n")
        return 4
    rc = util.do_cmd("./jenkins/review/review.py", 'app01pg')
    if not rc == 0:
        print("Error: Reviewing failed for: 'app01pg'!\n")
        return 4
    rc = util.do_cmd("./jenkins/review/review.py", 'app01sq')
    if not rc == 0:
