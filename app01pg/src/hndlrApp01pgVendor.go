...
func (h *HandlersApp01pgVendor) DB() *IO_App01pgVendor {
	return h.db
}

func (h *HandlersApp01pgVendor) SetDB(db *IO_App01pgVendor) {
	h.db = db
}
...
func NewHandlersApp01pgVendor(db *IO_App01pgVendor, rowsPerPage int, mux *http.ServeMux) *HandlersApp01pgVendor {
...
func (h *HandlersApp01pgVendor) RowDisplay(w http.ResponseWriter, rcd *App01pgVendor, msg string) {
	var err error
