...
//============================================================================
//                        Handlers for App01pg.Vendor
//============================================================================

type HandlersApp01pgVendor struct {
    mu          sync.Mutex
    db          *ioApp01pgVendor.IO_App01pgVendor
    rowsPerPage int
...
func (h *HandlersApp01pgVendor) DB() *ioApp01pgVendor.IO_App01pgVendor {
    return h.db
}

func (h *HandlersApp01pgVendor) SetDB(db *ioApp01pgVendor.IO_App01pgVendor) {
    h.db = db
}

func (h *HandlersApp01pgVendor) RowsPerPage() int {
    return h.rowsPerPage
}

func (h *HandlersApp01pgVendor) SetRowsPerPage(r int) {
    h.rowsPerPage = r
}
...
// with it given a mux.
func (h *HandlersApp01pgVendor) SetupHandlers(mux *http.ServeMux) {
...
func NewHandlersApp01pgVendor(db *ioApp01pgVendor.IO_App01pgVendor, rowsPerPage int, mux *http.ServeMux) *HandlersApp01pgVendor {
    var h       *HandlersApp01pgVendor

 	h = &HandlersApp01pgVendor{db:db, rowsPerPage:rowsPerPage}
    if h == nil {
        log.Fatalf("Error: Unable to allocate Handlers for hndlrApp01pgVendor!\n")
    }
    h.SetupHandlers(mux)
...
func (h *HandlersApp01pgVendor) ListFirst(w http.ResponseWriter, r *http.Request) {
...
func (h *HandlersApp01pgVendor) ListLast(w http.ResponseWriter, r *http.Request) {
    var err     error
    var offset  int
...
func (h *HandlersApp01pgVendor) ListNext(w http.ResponseWriter, r *http.Request) {
    var err     error
    var offset  int
    var cTable  int
...
func (h *HandlersApp01pgVendor) ListPrev(w http.ResponseWriter, r *http.Request) {
    var err     error
    var offset  int
    var begin   int
    var cTable  int
...
func (h *HandlersApp01pgVendor) ListShow(w http.ResponseWriter, offset int, msg string) {
    var err     error
    var rcds    []App01pgVendor.App01pgVendor
    var name    = "App01pg.Vendor.list.gohtml"
    ...
    data := struct {
                Rcds        []App01pgVendor.App01pgVendor
                Offset      int
                Msg         string
            }{rcds, offset, msg}
...
func (h *HandlersApp01pgVendor) RowDelete(w http.ResponseWriter, r *http.Request) {
    var err     error
...
func (h *HandlersApp01pgVendor) RowDisplay(w http.ResponseWriter, rcd  *App01pgVendor.App01pgVendor, msg string) {
    var err     error
    ...
    if h.Tmpls != nil {
        data := struct {
                    Rcd         *App01pgVendor.App01pgVendor
                    Msg         string
                }{rcd, msg}
        name := "App01pg.Vendor.form.gohtml"
...
func (h *HandlersApp01pgVendor) RowEmpty(w http.ResponseWriter, r *http.Request) {
    var rcd     App01pgVendor.App01pgVendor
...
func (h *HandlersApp01pgVendor) RowFind(w http.ResponseWriter, r *http.Request) {
    var err     error
    var rcd     App01pgVendor.App01pgVendor
    var msg     string
    var i       int
...
func (h *HandlersApp01pgVendor) RowFirst(w http.ResponseWriter, r *http.Request) {
    var rcd     App01pgVendor.App01pgVendor
    var err     error
...
func (h *HandlersApp01pgVendor) RowForm(w http.ResponseWriter, r *http.Request) {
    ...
    // Display the row in the form.
    http.ServeFile(w, r, "./tmpl/App01pg.Vendor.form.gohtml")
...
func (h *HandlersApp01pgVendor) RowInsert(w http.ResponseWriter, r *http.Request) {
    var rcd         App01pgVendor.App01pgVendor
    var err         error
...
func (h *HandlersApp01pgVendor) RowLast(w http.ResponseWriter, r *http.Request) {
    var rcd         App01pgVendor.App01pgVendor
    var err         error
...
func (h *HandlersApp01pgVendor) RowNext(w http.ResponseWriter, r *http.Request) {
    var rcd         App01pgVendor.App01pgVendor
    var err         error
    var i           int
    var key         string
...
func (h *HandlersApp01pgVendor) RowPrev(w http.ResponseWriter, r *http.Request) {
    var rcd         App01pgVendor.App01pgVendor
    var err         error
    var i           int
    var key         string
...
func (h *HandlersApp01pgVendor) RowShow(w http.ResponseWriter, r *http.Request) {
    var err         error
    var key         string
    var rcd         App01pgVendor.App01pgVendor
...
func (h *HandlersApp01pgVendor) RowUpdate(w http.ResponseWriter, r *http.Request) {
    var err         error
    var key         string
    var rcd         App01pgVendor.App01pgVendor
    var i           int
...
func (h *HandlersApp01pgVendor) TableCreate(w http.ResponseWriter, r *http.Request) {
    var err         error
...
func (h *HandlersApp01pgVendor) TableLoadCSV(w http.ResponseWriter, r *http.Request) {
    var err         error
    var rcd         App01pgVendor.App01pgVendor
...
// in some test rows.
func (h *HandlersApp01pgVendor) TableLoadTestData(w http.ResponseWriter, r *http.Request) {
    var err         error
    var rcd         App01pgVendor.App01pgVendor
...
// data from a CSV file.
func (h *HandlersApp01pgVendor) TableSaveCSV(w http.ResponseWriter, r *http.Request) {
    var err         error
    var cntGood     int
    var cntTotal    int
    ...
    if wtr != nil {
        ...
        log.Printf("\t%s - for App01pgVendor table!\n", util.ErrorString(err))
    }
