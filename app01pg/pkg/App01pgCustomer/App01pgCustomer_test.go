...
func TestTestDataApp01pgCustomer(t *testing.T) {
    var chr         rune
    var str         string
    var i64         int64
    var f64         float64
...
func TestToStringApp01pgCustomer(t *testing.T) {
    var str         string
    var strRcd      string
...
func TestToStringsApp01pgCustomer(t *testing.T) {
    var strs        []string
    var str         string
    var offset      int
