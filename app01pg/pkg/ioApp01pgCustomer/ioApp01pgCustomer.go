...
// Generated: Fri Oct 18, 2019 14:51 for postgres Database
...
func (io *IO_App01pgCustomer) RowDelete(rcd *App01pgCustomer.App01pgCustomer) error {
    var err         error
...
func (io *IO_App01pgCustomer) RowFind(rcd *App01pgCustomer.App01pgCustomer) error {
    var err         error
...
// without error.
func (io *IO_App01pgCustomer) RowFirst(rcd *App01pgCustomer.App01pgCustomer) error {
    var err         error
...
func (io *IO_App01pgCustomer) RowInsert(d *App01pgCustomer.App01pgCustomer) error {
    var err     error
...
func (io *IO_App01pgCustomer) RowLast(rcd *App01pgCustomer.App01pgCustomer) error {
    var err         error
...
func (io *IO_App01pgCustomer) RowNext(rcd *App01pgCustomer.App01pgCustomer) error {
    var err         error
...
func (io *IO_App01pgCustomer) RowPage(offset int, limit int) ([]App01pgCustomer.App01pgCustomer, error) {
    var err         error
    var sqlStmt = "SELECT * FROM public.customer ORDER BY num ASC LIMIT $1 OFFSET $2;\n"
    data := []App01pgCustomer.App01pgCustomer{}
...
func (io *IO_App01pgCustomer) RowPrev(rcd *App01pgCustomer.App01pgCustomer) error {
    var err         error
...
func (io *IO_App01pgCustomer) RowUpdate(d *App01pgCustomer.App01pgCustomer) error {
    var err     error
    var sqlStmt = "INSERT INTO public.customer (num, name, addr1, addr2, city, state, zip, curbal) VALUES ($1, $2, $3, $4, $5, $6, $7, $8);\n"
...
// them.
func (io *IO_App01pgCustomer) TableScan(apply func (rcd App01pgCustomer.App01pgCustomer) error) error {
    var sqlStmt = "DROP TABLE IF EXISTS public.customer;\n"
    var err     error
    var rcd     App01pgCustomer.App01pgCustomer
...
func NewIoApp01pgCustomer(io *ioApp01pg.IO_App01pg) *IO_App01pgCustomer {
