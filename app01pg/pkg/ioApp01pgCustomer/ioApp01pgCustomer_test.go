...
// they do not match.
func (td *App01pgCustomerTestData) CheckRcd(need int, rcd *App01pgCustomer) {
    var rcd2        App01pgCustomer
...
func TestApp01pgCustomerCreateDeleteTable(t *testing.T) {
    var err         error
    var td          *App01pgCustomerTestData
    var io          *IO_App01pgCustomer

	t.Logf("TestCreateTable()...\n")
	DockerRun(t)
	td = NewTestApp01pgCustomer()
	td.Setup(t)
	io = NewIoApp01pgCustomer(td.io)
...
func TestApp01pgCustomerRowInsert(t *testing.T) {
    var err         error
    var td          *App01pgCustomerTestData
    var io          *IO_App01pgCustomer
...
func TestApp01pgCustomerRowPage(t *testing.T) {
    var err         error
    var td          *App01pgCustomerTestData
    var io          *IO_App01pgCustomer
    var rcd         App01pgCustomer
...
func TestApp01pgCustomerTableScan(t *testing.T) {
    var err         error
    var td          *App01pgCustomerTestData
    var io          *IO_App01pgCustomer
    var rcd         App01pgCustomer
